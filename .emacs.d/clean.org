...
(pcase system-name
  ("dwhpd"
   ...
   (setq kk/contacts-file "~/documents/org/contacts.org"))
  ("T490s"
   ...
   (setq kk/contacts-file "~/Nextcloud/Documents/org/contacts.org")))
#+end_src
...
(setq org-contacts-files kk/contacts-file)
#+end_src
