...
^^^^^^^^------------------------------------------------------------------------------------
_i_: punch in                _t_: set                 _c_: search     _s_: helm agenda files
_o_: punch out               _T_: stop                _C_: send mail  _S_: ql-search
_I_: clock in at time        _C-t_: pause or continue ^ ^             _v_: view
...
"
  ...
  ("T" org-timer-stop)
  ("C-t" org-timer-pause-or-continue)
  ("h" bh/hide-other)
  ("c" org-contacts)
  ("C" org-contacts-view-send-email)
  ("v" org-ql-view)
  ("s" helm-org-ql-agenda-files)
  ("S" org-ql-search)
  ("q" nil))
