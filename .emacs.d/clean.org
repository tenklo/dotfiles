...
(use-package org-ql
  ...
  (use-package helm-org-ql
    :config
    (global-set-key (kbd "<f9> v") 'org-ql-view)
    (global-set-key (kbd "<f9> s") 'helm-org-ql-agenda-files)
    (global-set-key (kbd "<f9> S") 'org-ql-search)))
#+end_src
