...
(defun daedreth/kill-inner-word ()
  ...
  (backward-word)
  (kill-word 1))
(define-key edit-commands-map (kbd "w k") 'daedreth/kill-inner-word)
...
(defun daedreth/copy-whole-word ()
  ...
  (save-excursion
    ...
    (kill-word 1)
    (yank)))
(define-key edit-commands-map (kbd "w c") 'daedreth/copy-whole-word)
  ...
  (save-excursion
    (kill-new
     (buffer-substring
      (point-at-bol)
      (point-at-eol)))))
(define-key edit-commands-map (kbd "l c") 'daedreth/copy-whole-line)

(define-key edit-commands-map (kbd "l k") 'kill-whole-line)

(define-key edit-commands-map (kbd "l j") 'join-line)
...
(global-set-key (kbd "<f9> t") 'kk/tidy-buffer)
#+end_src
...
(setq kk/search-engines '(("amazon.de" . "https://www.amazon.de/s?k=")
                          ...
                          ("reddit.com" . "https://duckduckgo.com/?q=site:reddit.com+")
                          ...
                          ("w3schools.com" . "https://duckduckgo.com/?q=site:w3schools.com+")
                          ("wikipedia" . "https://de.wikipedia.org/wiki/")
                          ("wolframalpha" . "https://www.wolframalpha.com/?i=")
                          ("youtube" . "https://duckduckgo.com/?q=site:youtube.com+")
                          ("emacs wiki" . "https://duckduckgo.com/?q=site:emacswiki.org+")))
#+end_src
