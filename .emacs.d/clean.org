...
(pcase system-name
  ("dwhpd"
   ...
   (setq kk/default-task-id "62e548e1-3189-419a-96c9-c29251578cc2")
  ...
  ("T490s"
   ...
   (setq kk/default-task-id "e740c514-60b7-4a32-a8f9-efe15ebca7a0")
   (setq kk/emms-source-file-default-directory "/mnt/psnas/music/")
   (setq kk/clock-in-parent-tasks nil)))
#+end_src
...
(setq bh/organization-task-id kk/default-task-id)
...
(global-set-key (kbd "C-<f11>") 'kk/org-clock-in-list)
#+end_src
