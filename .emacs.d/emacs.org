...
*** Tags
:PROPERTIES:
:ID:       d606ad54-f825-46a2-b52b-bc009f73efaa
:END:
...
(defhydra kk/org-table-hydra (:hint nil)
  ...
  ^Org Tables^
  ^^^^^^^^-----------------------------------------------------------------
  _p_: prev       _P_: move up      _h_: hline & next line    _F_, _B_: move cols
...
(defhydra kk/hydra-org-things (:hint nil)
  "
^Clocking^                   ^Timer^                  ^Contacts^      ^Query^
^^^^^^^^------------------------------------------------------------------------------------
_i_: punch in                _t_: set                 _c_: search     _S_: ql-search
