...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq org-capture-templates
          `(("w" "Work")
            ("tt" "Task" entry (file+olp kk/work-agenda-file "Inbox")
             "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 0)
            ("tp" "Project" entry (file+olp kk/work-agenda-file "Inbox")
             "* PLAN %?\n  %U\n  %a\n  %i" :empty-lines 0)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c i D") 'insert-tomorrows-date-headline-standup)
...
#+begin_src emacs-lisp
  ...
  (defun insert-todays-date-headline-standup () (interactive)
         (insert
          (shell-command-to-string "echo -n \"* $(LC_ALL=de_DE.utf8 date '+%A %d. %B %Y')\"")))
  
  (defun insert-tomorrows-date-headline-standup () (interactive)
         (insert
          (shell-command-to-string
           "echo -n \"* $(LC_ALL=de_DE.utf8 date --date='tomorrow' '+%A %d. %B %Y')\"")))
