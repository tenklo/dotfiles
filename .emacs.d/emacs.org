...
#+begin_src emacs-lisp
  ...
  (defun kk/open-academical-calendar ()
    ...
    (interactive)
    (kk/open-calendar-with kk/school-diary-file (list kk/school-agenda-file)))
