...
(define-key edit-commands-map (kbd "L") 'display-line-numbers-mode)
...
(define-key edit-commands-map (kbd "T") 'typo-mode)
#+end_src
...
(use-package avy
  ...
  (setf (alist-get ?\M-c avy-dispatch-alist) 'avy-action-capitalize)
  ...
  (setf (alist-get ?\M-u avy-dispatch-alist) 'avy-action-upcase-item)
  ...
  (setf (alist-get ?\M-l avy-dispatch-alist) 'avy-action-downcase-item)
...
(defun kk/weekly-review-agenda ()
  ...
  (let ((org-agenda-sticky nil)
        ...
        (org-agenda-tag-filter-preset
         (list "-HOLD" (kk/weekly-review-filter-string))))
    (org-agenda-list)))
...
(defun kk/weekly-review-hold ()
  ...
  (let ((org-agenda-sticky nil)
        (org-agenda-tag-filter-preset
         (list (kk/weekly-review-filter-string))))
    (org-todo-list 5)))
...
(defun kk/toggle-margins ()
  (interactive)
  (setq kk/margins-active (not kk/margins-active))
