    ...
    (save-excursion
      ...
      (let* ((tags (vulpea-buffer-tags-get))
        ...
        (if (vulpea-agenda-file-p)
            (setq tags (cons "agenda-file" tags))
          (setq tags (remove "agenda-file" tags)))
...
(defun vulpea-agenda-file-files ()
  "Return a list of note files containing 'agenda-file' tag." ;
  (seq-uniq
   (seq-map
    #'car
    (org-roam-db-query
     [:select [nodes:file]
              ...
              :where (like tag (quote "%\"agenda-file\"%"))]))))
