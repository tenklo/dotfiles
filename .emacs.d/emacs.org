...
(use-package org
  ...
  (setq org-columns-default-format
        (concat "#+COLUMNS: %7TODO(Todo) %40ITEM(Task) %TAGS(Tag) "
...
(defhydra hydra-favorite-files ()
  ("e" (lambda ()
         (interactive)
         (find-file "~/.emacs.d/emacs.org")) "emacs.org")
  ("f" (lambda ()
         (interactive)
         (find-file "~/Nextcloud/Documents/fin/journal.ledger")) "emacs.org")
  ("J" (lambda ()
         (interactive)
         (find-file kk/personal-journal)) "journal")
  ("w" (lambda ()
         (interactive)
         (find-file kk/work-agenda-file)) "work agenda")
  ("W" (lambda ()
         (interactive)
         (find-file kk/work-diary-file)) "work diary")
  ("a" (lambda ()
         (interactive)
         (find-file kk/academical-agenda-file)) "school agenda")
  ("A" (lambda ()
         (interactive)
         (find-file kk/academical-diary-file)) "school diary")
  ("p" (lambda ()
         (interactive)
         (find-file kk/personal-agenda-file)) "personal agenda")
  ("P" (lambda ()
         (interactive)
         (find-file kk/personal-diary-file)) "personal diary"))
...
(custom-set-variables
 ...
 '(ledger-reports
   '(("Income vs Expenses" "ledger [[ledger-mode-flags]] -f /home/karsten/Nextcloud/Documents/fin/journal.ledger bal Income Expenses")
     ...
     ("Assets vs Liabilities" "ledger [[ledger-mode-flags]] -f /home/karsten/Nextcloud/Documents/fin/journal.ledger bal Assets Liabilities")
